...
begin
MessageDlg('Não a pendências referente a está parcela!',MtWarning,[mbok],0);
exit;
end;
...
begin
MessageDlg('Escolha uma conta corrente para movimentação do pagamento!',MtWarning,[mbok],0);
exit;
end;
