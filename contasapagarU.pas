...
begin
if MessageDlg('Deseja apagar a conta nº '+IntToStr(cod)+' do registro?',MtConfirmation,[mbyes,mbno],0)=mryes then
begin
if tbl_ContasPagar.RecordCount >0 then
begin
...
MessageDlg('Não a registros existentes a serem deletados!',MtError,[mbok],0);
btnDeletar.Enabled := false;
end else
abort;
end;
