...
prox : Integer;
begin
   If  MessageDlg('Você tem certeza que deseja criar um novo o registro?',MtConfirmation,[mbyes,mbno],0)=mryes
  then
    begin
  tbl_Usuario.Last;
...
then
  begin
    ...
    MessageDlg('Não registros a serem deletados!',MtWarning,[mbok],0);
    end
else
  abort;
...
tratabotoes;
editConsulta.Text := 'DIGITE O NOME DO USUÁRIO...';
