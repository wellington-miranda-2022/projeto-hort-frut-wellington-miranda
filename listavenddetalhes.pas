...
begin
MessageDlg('Não a vendas a serem apagadas!',MtWarning,[mbok],0);
exit;
end;
...
begin
if MessageDlg('Você ainda tem uma venda em aberto. Deseja cancelar?',MtInformation,[mbyes,mbno],0)=mryes then
begin
inserirqtd := 0;
...
ShowMessage('o nome do produto é '+produtoedit);
ShowMessage('a quantidade antiga é '+IntToStr(novavenda));
ShowMessage('agora é '+IntToStr(resultado));
